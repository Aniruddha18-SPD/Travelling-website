...
class CLI_packing:
    ...
    def book_package(self,customer_username):
        ...
        if this_package.package_name not in packages_available_with_us.keys():
            ...
            if int(this_package.price)<packages_available_with_us[this_package.package_name][0] or int(this_package.price)>packages_available_with_us[this_package.package_name][1]:
